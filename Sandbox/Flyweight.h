...
{
public:
    void render()   { std::cout << "rendering big image " << m_heavyData << std::endl; }
private:
    int m_heavyData{0};
};
...
{
public:
    Flyweight(int refId) : m_cache{ FlyweightCommonFactory::getObject(refId) }{}
    void render()   { m_cache->render(); }
